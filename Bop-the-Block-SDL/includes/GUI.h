...
private:
	...
	const std::string TOP_SCORE_LABEL = "TOP SCORE\n";
	...
	Text balls_text{ BALLS_LABEL + std::to_string(balls_prev), COLUMN_CENTER, ROW_START + ROW_OFFSET * 3, TEXT_WIDTH, TEXT_HEIGHT };
};
#endif
